...
# generate configurations of anchor nodes
...
# install chaincode at endorser nodes
...
# replace keys used in tape test
# command for testing on tape tps：./tape --config=config.yaml --number=100
